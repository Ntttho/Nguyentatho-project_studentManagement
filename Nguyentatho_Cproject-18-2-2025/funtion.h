...
void addNewStudent(struct Student *studentList2, int *numberOfStudent2, int check); // them moi sinh vien vao studentList2 va tang so luong sinh vien len 1
...
void actionWithFile(struct Student *studentList8, int *numberOfStudent8); // ghi file 
void readFile(struct Student *studentList9, int *numberOfStudent9); // doc file
// ==========================quan ly sinh vien========================
