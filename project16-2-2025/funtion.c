...
void addStudentToClass(struct Classroom *classroomList6, int numberOfclass6, struct Student *studenList){
};
...
// quan ly lop hoc
void classManagement(struct Classroom *classrooms, int *numberOfClass, int *numerOfStudent, struct Student *studentList){
	int t3 = 1;
	while(t3){
		menuClassManagement();
		...
		switch(choice5){
			...
			case 5:{
				system("cls");
				showFullInforClassroom(classrooms, *numberOfClass);
				break;
			}
			case 0:{
				system("cls");
